...
''' HITS.py Dan Levy, Conrad Dean, Andy Freeland  An implementation of HITS using the power method and sparse matrices to reduce memory usage. Takes in a dictionary where each key is a page url. The value is a list of links at that page url. See example program in main for how to run. '''
...
def clean_pages(pages):
    ...
    for page in pages:
        ...
        for outside_link in outside_links:
            dd  = pages[page].pop(outside_link)
    return pages
